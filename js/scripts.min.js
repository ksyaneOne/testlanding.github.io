...
function makeTimer() {
	var e = new Date("October 6, 2017 23:00:00 PDT"),
		e = Date.parse(e) / 1e3,
		t = new Date,
		t = Date.parse(t) / 1e3,
		o = e - t,
		n = Math.floor(o / 86400),
		a = Math.floor((o - 86400 * n) / 3600),
		r = Math.floor((o - 86400 * n - 3600 * a) / 60),
		s = Math.floor(o - 86400 * n - 3600 * a - 60 * r);
	a < "10" && (a = "0" + a), r < "10" && (r = "0" + r), s < "10" && (s = "0" + s), $(".days").html(n), $(".hours").html(a), $(".minutes").html(r), $(".seconds").html(s)
}
...
setInterval(function () {
	makeTimer()
}, 1e3), document.ondragstart = noselect, document.onselectstart = noselect, document.oncontextmenu = noselect;
